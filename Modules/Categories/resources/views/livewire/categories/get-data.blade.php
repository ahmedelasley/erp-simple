            ...
            @forelse ($data as $value)
                <tr>
                    ...
                    <x-core::tables.partials.action-button
                        :actions="[
                            ['label' => __('Details'), 'event' => 'show_category', 'id' => $value->id, 'icon' => 'bx bx-info-circle'],
                            ['label' => __('Edit'), 'event' => 'edit_category', 'id' => $value->id, 'icon' => 'bx bx-edit'],
                            ['divider' => true],
                            ['label' => __('Delete'), 'event' => 'delete_category', 'id' => $value->id, 'icon' => 'bx bx-trash', 'class' => 'text-danger', 'confirm' => true],
                        ]"
                    />
