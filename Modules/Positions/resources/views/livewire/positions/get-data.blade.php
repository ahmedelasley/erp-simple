        ...
        <div class="card-body">
            @php
                $columns=[
                    ...
                    ['label' => 'Description'],
                    ['label' => 'Level', 'clickBtn' => 'sortBy' ,'sortField' => 'level', 'sortDirection' => 'desc'],
            ...
            @forelse ($data as $value)
                <tr>
                    ...
                    <td><b><x-core::partials.badge :label="$value->level" /></b></td>
                    ...
                    <x-core::tables.partials.action-button
                        :actions="[
                            ['label' => __('Details'), 'event' => 'show_position', 'id' => $value->id, 'icon' => 'bx bx-info-circle'],
                            ['label' => __('Edit'), 'event' => 'edit_position', 'id' => $value->id, 'icon' => 'bx bx-edit'],
                            ['divider' => true],
                            ['label' => __('Delete'), 'event' => 'delete_position', 'id' => $value->id, 'icon' => 'bx bx-trash', 'class' => 'text-danger', 'confirm' => true],
                        ]"
                    />
