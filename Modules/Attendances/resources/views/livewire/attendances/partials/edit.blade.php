...
<form id="form">
    ...
    <x-core::form.fields.input-label-error type="datetime-local"  livewire="true" name="check_in" placeholder="Enter Check in"  label="Check in" value="{{old('check_in')}}" required />
    <x-core::form.fields.input-label-error type="datetime-local" livewire="true" name="check_out" placeholder="Enter Check out"  label="Check out" value="{{old('check_out')}}" required />
