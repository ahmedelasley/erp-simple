...
namespace Modules\Attendances\Livewire\Attendances;
...
class GetData extends Component
{
    ...
    protected $listeners = [
        ...
        'show_attendance' => '$refresh',
        'edit_attendance' => '$refresh',
        // 'toggle_status_attendance' => '$refresh',
        'delete_attendance' => '$refresh',
    ...
    public function render(AttendanceServiceInterface $service)
    {
        ...
        return view('attendances::livewire.attendances.get-data', [
            'data' => $data,
        ]);
    }
}
